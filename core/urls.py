...
from file.views import (
    ...
    OcsCapabilitiesView, SharedFolderCreateView, SharedFolderRenameView, SharedFolderDeleteView, SharedFolderMembersView,
    ...
    CalendarWebView, CalendarCreateView, CalendarRenameView, CalendarDeleteView,
    CalendarShareAddView, CalendarShareDeleteView,
    EventCreateView, EventDeleteView, EventMoveView, EventInviteeAddView, EventInviteeRemoveView, CalendarEventsApiView,
    ContactsWebView, AddressBookCreateView, AddressBookDeleteView,
    AddressBookRenameView, AddressBookShareAddView, AddressBookShareDeleteView,
    ContactCreateView, ContactDeleteView, ContactUpdateView, ContactMoveView,
    MailWebView, MailboxCreateView, MailboxRenameView, MailboxDeleteView,
    EmailToggleReadView, EmailDeleteView, EmailMoveView, TrashEmptyView, EmailAttachmentDownloadView, EmailDetailApiView,
    MailComposeView, MailSendView, ContactSearchView, FilePickerView, ContactFolderCreateView,
    ContactGroupListView, ContactGroupCreateView, ContactGroupDetailView,
    ContactGroupAddMemberView, ContactGroupRemoveMemberView,
    ContactGroupMoveView, ContactGroupDeleteView, ContactGroupFolderCreateView,
    MailSettingsView, SignatureCreateView, SignatureUpdateView,
    SignatureDeleteView, SignatureContentView, OutOfOfficeUpdateView,
...
urlpatterns = [
    ...
    path('api/shared-folders/<int:sf_id>/rename/', SharedFolderRenameView.as_view(), name='api_shared_folder_rename'),
    path('api/shared-folders/<int:sf_id>/delete/', SharedFolderDeleteView.as_view(), name='api_shared_folder_delete'),
    ...
    path('api/contact-groups/list/', ContactGroupListView.as_view(), name='api_contact_group_list'),
    path('api/contact-groups/create/', ContactGroupCreateView.as_view(), name='api_contact_group_create'),
    path('api/contact-groups/<int:group_id>/', ContactGroupDetailView.as_view(), name='api_contact_group_detail'),
    path('api/contact-groups/<int:group_id>/add/', ContactGroupAddMemberView.as_view(), name='api_contact_group_add'),
    path('api/contact-groups/<int:group_id>/remove/<int:contact_id>/', ContactGroupRemoveMemberView.as_view(), name='api_contact_group_remove'),
    path('api/contact-groups/<int:group_id>/move/', ContactGroupMoveView.as_view(), name='api_contact_group_move'),
    path('api/contact-groups/<int:group_id>/delete/', ContactGroupDeleteView.as_view(), name='api_contact_group_delete'),
    path('api/contact-group-folders/create/', ContactGroupFolderCreateView.as_view(), name='api_contact_group_folder_create'),
    ...
    path('api/calendars/<int:calendar_id>/rename/', CalendarRenameView.as_view(), name='api_calendar_rename'),
    ...
    path('api/events/<int:event_id>/move/', EventMoveView.as_view(), name='api_event_move'),
    path('api/events/<int:event_id>/invitees/add/', EventInviteeAddView.as_view(), name='api_event_invitee_add'),
    path('api/events/<int:event_id>/invitees/<int:invitee_id>/remove/', EventInviteeRemoveView.as_view(), name='api_event_invitee_remove'),
    ...
    path('api/addressbooks/<int:addressbook_id>/rename/', AddressBookRenameView.as_view(), name='api_addressbook_rename'),
    ...
    path('api/contacts/<int:contact_id>/move/', ContactMoveView.as_view(), name='api_contact_move'),
    ...
    path('api/mail/<int:email_id>/', EmailDetailApiView.as_view(), name='api_email_detail'),
    path('mail/<int:email_id>/toggle-read/', EmailToggleReadView.as_view(), name='email_toggle_read'),
    ...
    path('mail/settings/create-signature/', SignatureCreateView.as_view(), name='signature_create'),
    path('mail/settings/signatures/<int:sig_id>/update/', SignatureUpdateView.as_view(), name='signature_update'),
    path('mail/settings/signatures/<int:sig_id>/delete/', SignatureDeleteView.as_view(), name='signature_delete'),
    path('mail/settings/signatures/<int:sig_id>/content/', SignatureContentView.as_view(), name='signature_content'),
    path('mail/settings/out-of-office/', OutOfOfficeUpdateView.as_view(), name='ooo_update'),
    path('mail/shared/create/', SharedMailboxCreateView.as_view(), name='shared_mailbox_create'),
    path('mail/shared/<int:sm_id>/update/', SharedMailboxUpdateView.as_view(), name='shared_mailbox_update'),
